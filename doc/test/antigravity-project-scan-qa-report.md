...
- [PASS] Global scan discovers configured root folders. Expected `/api/scan?range=all` to discover projects under `/Users/demo/Developer/projects` and `/Users/demo/Developer/projects`; actual project count 20, Side projects count 14, Project_exception count 6.
